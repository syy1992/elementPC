      ...
      <el-form :inline="true" :model="achievementObj" class="demo-form-inline min-width">
        ...
        <el-form-item label="产品名称:">
          <el-select v-model="achievementObj.productNo" placeholder="请选择产品" size="small" clearable>
            <el-option v-for="(item,index) in productList" :key="index"  :label="item.infoValue" :value="item.infoKey">
            </el-option>
          </el-select>
        </el-form-item>

        <el-form-item>
          <el-button type="primary" size="small" @click="onSubmit()">查询产品业绩</el-button>
        </el-form-item>
      </el-form>
